...
namespace CrawlerService.Data
{
    ...
    public interface IUrlFrontierRepository
    {
        ...
        /// <remarks>When URL is added to the frontier date/time is added also which tells when it can be requested next time.
        /// The information about that can be retrieved from robots.txt or from default settings.</remarks>
        /// <returns></returns>
