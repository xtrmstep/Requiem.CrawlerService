...
{
    internal class CrawlerDbContext : DbContext, ICrawlerDbContext
    {
        public CrawlerDbContext()
            : base("CrawlerDb") {}

        public IDbSet<UrlItem> UrlItems
        {
            get;
            set;
        }

        public IDbSet<HostSetting> HostSettings
        {
            get;
            set;
        }

        public IDbSet<DataBlock> DataBlocks
        {
            get;
            set;
        }

        public IDbSet<CrawlRule> CrawlRules
        {
            get;
            set;
        }

        public IDbSet<JobItem> JobItems
        {
            get;
            set;
        }

        public IDbSet<ActivityMessage> ActivityMessages
        {
            get;
            set;
        }
